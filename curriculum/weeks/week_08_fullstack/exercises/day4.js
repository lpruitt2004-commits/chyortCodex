...
// Goal: Serve a static client and wire it to the API.
...
// Serve static client (use exercises/day4_client during exercise)
app.use('/', express.static(path.join(__dirname, 'day4_client')));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => console.log(`Day 4 server on ${PORT}`));
